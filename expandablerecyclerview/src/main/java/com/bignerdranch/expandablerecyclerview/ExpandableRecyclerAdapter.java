...
public abstract class ExpandableRecyclerAdapter<P extends Parent<C>, C, PVH extends ParentViewHolder, CVH extends ChildViewHolder>
     ...
     * that determines if the list item is a parent or a child and calls through
     * to the appropriate implementation of either {@link #onBindParentViewHolder(ParentViewHolder, int, Parent, List)}
     * or {@link #onBindChildViewHolder(ChildViewHolder, int, int, Object, List)}.
     *
     * @param holder The RecyclerView.ViewHolder to bind data to
     * @param flatPosition The index in the merged list of children and parents at which to bind
     ...
     *
     * @param childViewHolder The {@code CVH} to bind data to
     * @param parentPosition The index in the list at which to bind
     * @param childPosition The position of the child to bind
     * @param child The child which holds that data to be bound to the {@code CVH}
     ...
     */
    @UiThread
    public void onBindChildViewHolder(@NonNull CVH childViewHolder, int parentPosition, int childPosition, @NonNull C child,
     ...
     * {@link #onBindParentViewHolder(ParentViewHolder, int, Parent, List)} and
     * {@link #onBindChildViewHolder(ChildViewHolder, int, int, Object, List)} if the
     * item is already represented by a ViewHolder and it will be rebound to the same
     * ViewHolder. A notifyParentItemChanged() with null payload will clear all existing
     * payloads on that item and prevent future payload until
     * {@link #onBindParentViewHolder(ParentViewHolder, int, Parent, List)} and
     * {@link #onBindChildViewHolder(ChildViewHolder, int, int, Object, List)} is called.
     ...
     * {@link #onBindChildViewHolder(ChildViewHolder, int, int, Object, List)} if the
     * item is already represented by a ViewHolder and it will be rebound to the same
     * ViewHolder. A notifyChildItemChanged() with null payload will clear all existing
     * payloads on that item and prevent future payload until
     * {@link #onBindChildViewHolder(ChildViewHolder, int, int, Object, List)} is called.
     * Adapter should not assume that the payload will always be passed to onBindParentViewHolder(),
